...
function displayPics() {
  ...
  // When const used a variable declaration can be scoped to a code block like while loop, put var can be called outside outside while loop that made inside it.
  console.log(viewed);
